...
export default function IncludeSection() {
    return (
    <div>
        <section className="bg-[var(--color-neutral-700)] text-[var(--color-background)] py-32 px-6">
            <div className="max-w-6xl mx-auto text-center mb-20">
                <h2 className="text-4xl md:text-5xl font-display font-bold">
                    Your Website — Fully Equipped
                </h2>
            </div>
        ...
        <section className="bg-[var(--color-background)] text-white py-24 px-6 text-center">
            <div className="max-w-2xl mx-auto">
                <h2 className="text-[var(--color-foreground)] text-4xl md:text-5xl font-display font-bold">
